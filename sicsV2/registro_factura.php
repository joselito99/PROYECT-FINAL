...
<p class="texto">REGISTRO DE FACTURA</p>		
<div class="form-style-6">

<form name="caca" method="post" action="neg_registro_factura.php" autocomplete="OFF">

<input type="date" name="fecha_factura" id="fecha_factura" placeholder="Fecha Factura" />

<input type="number" name="numero_factura" id="numero_factura" placeholder="Numero de Factura"/>
