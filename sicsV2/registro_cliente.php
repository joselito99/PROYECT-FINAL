...
<p class="texto">REGISTRO CLIENTE</p>		
<div class="form-style-6">

<form name="caca" method="post" action="neg_registro_cliente.php" autocomplete="OFF">

<input type="text" name="Nombre_cliente" id="Nombre_cliente" placeholder="Nombre cliente" />

<input type="text" name="Apellido_cliente" id="Apellido_cliente" placeholder="Apellido cliente"/>

<input type="number" name="Documento_cliente" id="Documento_cliente" placeholder="Documento cliente"/>

<input type="number" name="Telefono_cliente" id="Telefono_cliente" placeholder="Telefono cliente"/>

<input type="text" name="Direccion_cliente" id="Direccion_cliente" placeholder="Direccion cliente"/>
