...
<form name="caca" method="post" action="neg_registro_producto.php" autocomplete="OFF">

<input type="text" name="Nombre_producto" id="Nombre_producto" placeholder="Nombre producto" />
<input type="text" name="Descripcion_producto" id="Descripcion_producto" placeholder="Descripcion producto"/>
<input type="text" name="Codigo_producto" id="Codigo_producto" placeholder="Codigo_producto"/>
