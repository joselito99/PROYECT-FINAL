...
<div class="container_registro">
		<div class="form__top">
		  <h2>REGISTRO <span>PROVEEDOR</span></h2>
		</div>		
		<form id="form2" name="form2" method="post" action="neg_registro_proveedor.php" autocomplete="OFF">
        		<p align="center">
        		<input class="input" type="text" placeholder="&#128100;  Nombre" id="Nombre_Proveedor" name="Nombre_Proveedor" required>
        		  
              <input class="input" type="text" name="Apellido_Proveedor" id="Apellido_Proveedor" placeholder="&#128100;  Apellido" required>
              
              <input class="input" type="text" id="Documento_Proveedor" name="Documento_Proveedor" placeholder="&#8962;  Documento" required>
        		  
              <input class="input" type="text" id="Direccion_Proveedor" name="Direccion_Proveedor" placeholder="&#8962;  Direccion" required>
              
              <input class="input" type="text" id="Telefono_Proveedor" name="Telefono_Proveedor" placeholder="&#8962;  Telefono" required>
