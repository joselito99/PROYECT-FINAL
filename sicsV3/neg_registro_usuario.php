...
<table width="1410" border="0" align="center">
  ...
  <tr>
    <td height="258" align="center" valign="top" bgcolor="#9AD1ED" class="parrafo"><p align="right">
	  ...
	  class Registro
	  {
		  public function registar($Nombre_usuario,$Apellido_usuario,$Documento_usuario,$Telefono_usuario,$Direccion_usuario,$Contrasena,$fk_id_rol) 
		 {
		...
		if (!$result = $db->query($sql))
		{
			...
			if ($userexiste=="0")
			{
				$sql2= "INSERT INTO usuario (idUsuario, Nombre_usuario, Apellido_usuario,Documento_usuario, Telefono_usuario, Direccion_usuario,Contrasena,fk_id_rol) VALUES (NULL,'$Nombre_usuario','$Apellido_usuario','$Documento_usuario','$Telefono_usuario','$Direccion_usuario','$Contrasena','$fk_id_rol')";
		...
		$nuevo = new Registro();
		$nuevo->registar($_POST["Nombre_usuario"],$_POST["Apellido_usuario"],$_POST["Documento_usuario"],$_POST["Telefono_usuario"],$_POST["Direccion_usuario"],$_POST["Contrasena"],$_POST["fk_id_rol"])
