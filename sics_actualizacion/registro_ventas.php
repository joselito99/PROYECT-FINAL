		  ...
		  <div align="center">
		    <ul class="menu">
		      ...
		      <li class="item-submenu" menu="2">
		        ...
		        <ul class="submenu">
		          <li class="title-menu"><span class="fa fa-bar-chart icon-menu"></span>Ventas</li>
		          <li class="go-back">Atras</li>
		          
		          <li><a href="registro_ventas.php">Registrar Ventas</a></li>
		          <li><a href="#">Cantidad Ventas</a></li>
...
<?php
$ddusuario=$_SESSION["Documento_usuario"];
?>
