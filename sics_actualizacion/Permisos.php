...
<div class="divprincipal" >
        ...
        <form id="form1" name="form1" method="post" action="neg_registro_permisos.php">
          <p>ROL
         ...
         ?>
          ...
          <p>
            <input type="submit" name="button" class="button"  value="GUARDAR" />
          </p>
        </form>
