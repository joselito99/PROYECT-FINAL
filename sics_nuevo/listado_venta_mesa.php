...
<center>  <a href="reporte_mesa.php" class="btn btn-success" role="button">Seleccione Mesa</a></center><br><br>
    ...
    <div class="container">
      ...
      class ListarVenta
      {
        ...
        public function Listar($idMesa)
        {

          include ('conexion.php');

    $sql="SELECT * FROM detalle_venta INNER JOIN ventas ON detalle_venta.`ventas_idVenta` = ventas.`idVenta` INNER JOIN mesa ON ventas.`mesa_idMesa` = mesa.`idMesa` WHERE idMesa = '$idMesa' ";
