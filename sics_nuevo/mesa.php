...
<link rel="stylesheet" type="text/css" href="librerias/bootstrap/css/bootstrap.css">
  ...
  <script src="php/Mesa/funciones_mesa.js"></script>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Agrega nueva mesa</h4>
      </div>
      <div class="modal-body">
            <label>Numero Mesa</label>
            <input type="text" name="" id="Numero_mesa" class="form-control input-sm">            
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal" id="guardarnuevamesa">
        Agregar
        </button>
...
<div class="modal fade" id="modalEdicion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Actualizar Mesa</h4>
      </div>
      <div class="modal-body">
            <input type="text" hidden="" id="idMes" name="idMes">
             <label>Numero Mesa</label>
            <input type="text" name="" id="Numero_mesau" class="form-control input-sm">
            
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" id="actualizamesa" data-dismiss="modal">Actualizar</button>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#guardarnuevamesa').click(function(){
          Numero_mesa=$('#Numero_mesa').val();
         
            agregarMesa(Numero_mesa);
        });



        $('#actualizamesa').click(function(){
          actualizaMesa();
        });
