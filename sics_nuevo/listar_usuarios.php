...
<link rel="stylesheet" type="text/css" href="librerias/bootstrap/css/bootstrap.css">
  ...
  <script src="php/Usuario/funciones_usuario.js"></script>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <label>Nombre</label>
            <input type="text" name="" id="Nombre_user" class="form-control input-sm">
            <label>Apellido</label> 
            <input type="text" name="" id="Apellido_user" class="form-control input-sm">
            <label>Tipo Documento</label>
             <select name="Tipo_documento" id="Tipo_documento_user" class="form-control input-sm">
                    <option placeholder="Seleccione Tipo Documento">
            ...
            <input type="text" name="" id="Documento_user" class="form-control input-sm" readonly>
            <label>Telefono</label>
            <input type="text" name="" id="Telefono_user" class="form-control input-sm">
            <label>Direccion</label>
            <input type="text" name="" id="Direccion_user" class="form-control input-sm">
            ...
            <!--<label>Direccion</label>
            <select name="Estado_productou" id="Estado_productou" class="form-control input-sm" t>
                Seleccione
                <option value="Activo" class="form-control input-sm">Activo</option>
                <option value="Inactivo" class="form-control input-sm">Inactivo</option>
            </select>-->
      </div>
