...
<p class="texto">REGISTRO DE MESAS</p>		
<div class="form-style-6">

<form name="caca" method="post" action="neg_registro_mesas.php" autocomplete="OFF">

<input type="number" name="Numero_mesa" id="Numero_mesa" placeholder="Numero de mesa" />	
