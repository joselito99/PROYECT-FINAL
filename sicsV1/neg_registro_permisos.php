		...
		<aside class="navegacion">
		  <div align="center">
		    <ul class="menu">
		      ...
		      <li><a href="#"><span class="fa fa-envelope icon-menu"></span>Platos</a></li>
		      <li><a href="registro_usuario.php"><span class="fa fa-address-book icon-menu"></span>Registro de Usuarios</a></li>
		      <li><a href="#"><span class="fa fa-address-book icon-menu"></span>Permisos</a></li>
	        </ul>
	  </div>
	  </aside>
	    </nav>
...
<p>
    ...
    <?php
	  ...
	  class Registro
	  {
		  public function registar($Usuario_idUsuario,$Rol_idRol) 
		 {
		...
		$sql= "SELECT * FROM permisos WHERE Usuario_idUsuario='$Usuario_idUsuario'";
		if (!$result = $db->query($sql))
		{
			...
			{
				$Uusuario_idUsuario=stripslashes($row["Usuario_idUsuario"]);
			...
			if ($userexiste=="0")
			{
$sql2= "INSERT INTO permisos (Usuario_idUsuario,Rol_idRol) VALUES ('$Usuario_idUsuario','$Rol_idRol')";
			if (!$result2 = $db->query($sql2)){
			die ('Error de conexion[' . $db->error . ']');
			} 
   				echo " <font class=letrar> ¡¡PERMISO REGISTRADO!! </font>";
			}
		...
		$nuevo=new Registro();
		$nuevo->registar($_POST["Usuario_idUsuario"],$_POST["Rol_idRol"])
